...
module.exports.getAnEarningCategoryByOrganizationId = async (req, res, next) => {
...
module.exports.getAnEarningCategoryByOrganizationIdAndCourseId = async (req, res, next) => {
    const organizationId = req.params.organizationId;
